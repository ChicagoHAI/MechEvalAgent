...
CIRCUIT_PROMPTS=("prompts/research_agent_input/circuit_prompt_ioi.txt")
...
Options:
  ...
  --task-name TASK_NAME    Name of the task [default: experiment]
...
RUN_DIR="YOUR_PATH/open_question/${TASK_NAME}_${PROVIDER_LIST}_${RUN_TIMESTAMP}"
